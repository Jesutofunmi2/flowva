...
const RewardHub = () => {
  ...
  return (
    <MetaSetter
      title="Test Engine / Assessment Platform Solution, CLUBHub | Reward Hub"
      description="Explore and manage your rewards on Test Engine / Assessment Platform Solution, CLUBHub."
    >
      ...
      <div className={globalStyles.responsiveGrid}>
        ...
        <SpotlightCard
          ...
          image="https://api.Test Engine / Assessment Platform Solution,hub.com/storage/v1/object/public/icons/reclaim.png"
        />
      </div>
      <SecondaryComponents.RewardHeading>
        Earn More Points
      ...
      <div className={globalStyles.responsiveGrid}>
        ...
        <SecondaryComponents.ShareStack
          points={25}
          shareText="Check out my stack on Test Engine / Assessment Platform Solution, CLUBHub!"
          shareUrl="https://app.Test Engine / Assessment Platform Solution,hub.com/my-stack"
          onShareSuccess={() => {
