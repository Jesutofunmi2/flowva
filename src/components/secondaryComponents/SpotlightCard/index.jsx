...
const SpotlightCard = ({
  ...
  description = "Reclaim.ai is an AI-powered calendar assistant that automatically schedules your tasks, meetings, and breaks to boost productivity. Free to try — earn Test Engine / Assessment Platform Solution, CLUBPoints when you sign up!",
  image,
  onPrimary,
  onSecondary,
  primaryText = "Sign up",
